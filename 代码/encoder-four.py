...
if __name__ == '__main__':
    ...
    weights = {
        ...
        'decoder_h4': tf.Variable(tf.truncated_normal([n_hidden_1, feature_size], )),
    }
    ...
    biases = {
        ...
        'decoder_b4': tf.Variable(tf.random_normal([feature_size])),
    }
    ...
    scio.savemat('../Data/combile_fourth_hidden_Data/non_rate/25_20_15_10fault_1000_number_EEMD_DE-FE-BA-MFE.mat.mat', {'output': File_hidden})
